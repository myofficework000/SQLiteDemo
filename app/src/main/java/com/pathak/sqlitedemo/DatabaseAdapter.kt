...
import com.pathak.sqlitedemo.databinding.DatabaseListBinding

class DatabaseAdapter(private val user: List<MyUser>) :
    RecyclerView.Adapter<DatabaseAdapter.DatabaseViewHolder>() {
    private lateinit var binding: DatabaseListBinding

    inner class DatabaseViewHolder(private val binding: DatabaseListBinding) :
